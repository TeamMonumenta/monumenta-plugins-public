...
ssh -p 9922 epic@admin.playmonumenta.com "cd /home/epic/play/project_epic/server_config/plugins && rm -f Monumenta-Bungee-Plugins.jar ; ln -s $plugin Monumenta-Bungee-Plugins.jar"
