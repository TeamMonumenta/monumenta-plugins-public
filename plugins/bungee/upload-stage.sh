...
ssh -p 9922 epic@admin.playmonumenta.com "cd /home/epic/stage/project_epic/server_config/plugins && rm -f Monumenta-Bungee-Plugins.jar ; ln -s $plugin Monumenta-Bungee-Plugins.jar"
