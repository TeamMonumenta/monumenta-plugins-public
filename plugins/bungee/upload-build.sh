...
ssh -p 9922 epic@build.playmonumenta.com "cd /home/epic/project_epic/server_config/plugins && rm -f Monumenta-Bungee-Plugins.jar ; ln -s $plugin Monumenta-Bungee-Plugins.jar"
