...
dependencies {
    ...
    compileOnly("com.playmonumenta:scripted-quests:6.10")
    ...
    doLast {
        ssh.runSessions {
            session(adminssh) {
                ...
                execute("cd /home/epic/play/m16/server_config/plugins && rm -f Monumenta.jar && ln -s " + shadowJar.archiveFileName.get() + " Monumenta.jar")
            }
        }
    }
}
