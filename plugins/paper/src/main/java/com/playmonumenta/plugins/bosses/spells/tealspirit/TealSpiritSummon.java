...
public class TealSpiritSummon extends Spell {
	...
	private static final LoSPool NORMAL_POOL = new LoSPool.LibraryPool("~TealNormalMobs");
	private static final LoSPool ELITE_POOL = new LoSPool.LibraryPool("~TealEliteMobs");
