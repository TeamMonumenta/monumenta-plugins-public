...
public enum Location {
	...
	ORANGE("orange", "Fallen Menagerie", TextColor.fromHexString("#FF8000")),
	...
	HALLOWEENSKIN("halloweenskin", "Halloween Skin", TextColor.fromHexString("#FF6600")),
	...
	AMBER("amber", "item name color", TextColor.fromHexString("#FFAA00")),
