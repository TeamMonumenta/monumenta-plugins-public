...
public class HorseFoodOverride extends BaseOverride {
	...
	public boolean rightClickEntityInteraction(Plugin plugin, Player player, Entity clickedEntity, ItemStack itemInHand) {
		...
		return clickedEntity == null || !(clickedEntity instanceof Horse) || (!ItemStatUtils.hasEnchantment(itemInHand, EnchantmentType.INFINITY) && !SteelStallion.isSteelStallion(clickedEntity));
	}
}
