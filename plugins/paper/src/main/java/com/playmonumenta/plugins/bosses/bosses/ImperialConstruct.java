...
public class ImperialConstruct extends BossAbilityGroup {
	...
	public ImperialConstruct(Plugin plugin, LivingEntity boss, Location spawnLoc, Location endLoc) {
		...
		if (mEncounterType.equals("Hard")) {
			...
			mSpread = new SpellSteelboreSpread(plugin, boss, 11, mSpawnLoc, 35);
			mSpread2 = new SpellSteelboreSpread(plugin, boss, 11, mPhase2Loc, 35);
			mSpreadSmall = new SpellSteelboreSpread(plugin, boss, 6, mPhase3Loc, 35);
