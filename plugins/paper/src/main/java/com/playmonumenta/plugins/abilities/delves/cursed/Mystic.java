...
public class Mystic extends StatMultiplier {
	...
	private static final double MYSTIC_MOB_HEALTH_MULTIPLIER = 1.35;
	private static final double MYSTIC_1_ABILITY_DAMAGE_TAKEN_MULTIPLIER = 0.6;
	private static final double MYSTIC_2_ABILITY_DAMAGE_TAKEN_MULTIPLIER = 1.5;
