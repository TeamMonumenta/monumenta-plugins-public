...
public class AdventureChargeUpManager {
	private int mTime;
	...
	public AdventureChargeUpManager(Entity boss, int chargeTime, Component title, BossBar.Color color, BossBar.Overlay style, int range) {
		this(boss.getLocation(), boss, chargeTime, title, color, style, range);
	}

	public AdventureChargeUpManager(Location loc, @Nullable Entity boss, int chargeTime, Component title, BossBar.Color color, BossBar.Overlay style, int range) {
		mLoc = loc;
