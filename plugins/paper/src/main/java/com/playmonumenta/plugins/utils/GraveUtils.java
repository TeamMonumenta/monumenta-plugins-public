...
public class GraveUtils {
	...
	//TODO This method only exists for old deaths from before the grave changes. Delete this after a few weeks when all these items should be gone.
	public static void destroyItemEntity(Item entity) {
		ItemStack item = entity.getItemStack();
		if (entity.getScoreboardTags().contains("PlayerDeath")) {
