	...
	public void death(EntityDeathEvent event) {
		...
		new SpellDelayedAction(mPlugin, mBoss.getLocation(), 25,
		                       ...
		                       (Location loc) -> {
		                           ...
		                           for (int i = 0; i < 2; i++) {
									   EntityUtils.summonEntityAt(loc, EntityType.ZOMBIFIED_PIGLIN, "{Anger:32767s,CustomName:\"{\\\"text\\\":\\\"Fire Imp\\\"}\",Passengers:[{Potion:{id:\"minecraft:splash_potion\",Count:1b,tag:{CustomPotionEffects:[{Ambient:0b,ShowIcon:1b,ShowParticles:1b,Duration:1200,Id:12b,Amplifier:0b}],Potion:\"minecraft:empty\"}},id:\"minecraft:potion\"}],IsBaby:1b,Health:30.0f,ArmorItems:[{id:\"minecraft:leather_boots\",Count:1b,tag:{display:{color:5643800,Name:\"{\\\"text\\\":\\\"§fInfernal Boots\\\"}\"}}},{id:\"minecraft:leather_leggings\",Count:1b,tag:{display:{color:5643800,Name:\"{\\\"text\\\":\\\"§fInfernal Pants\\\"}\"}}},{id:\"minecraft:leather_chestplate\",Count:1b,tag:{display:{color:5643800,Name:\"{\\\"text\\\":\\\"§fInfernal Tunic\\\"}\"}}},{id:\"minecraft:player_head\",Count:1b,tag:{SkullOwner:{Id:\"ca9c48a8-6147-390d-858d-4a4e9807d067\",Properties:{textures:[{Value:\"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmQ0YWJiYjRiZWM0NjlkN2E3NWNkNzQ2ZTIyMmIwYThiZWRmOTc0MzVhNjFkN2IwODNkZjc5ZDk0MDY0YiJ9fX0=\"}]}}}}],Attributes:[{Base:30.0d,Name:\"generic.maxHealth\"}],id:\"minecraft:zombified_piglin\",HandItems:[{id:\"minecraft:blaze_powder\",Count:1b,tag:{display:{Name:\"{\\\"text\\\":\\\"§4§lBlazing Soul\\\"}\"},Enchantments:[{lvl:1s,id:\"minecraft:unbreaking\"}],AttributeModifiers:[{UUIDMost:6643163485254798509L,UUIDLeast:-9135644038788542450L,Amount:-0.08d,Slot:\"mainhand\",AttributeName:\"generic.movementSpeed\",Operation:1,Name:\"Modifier\"},{UUIDMost:-2899840319788137997L,UUIDLeast:-6474403868551417057L,Amount:10.0d,Slot:\"mainhand\",AttributeName:\"generic.attackDamage\",Operation:0,Name:\"Modifier\"}]}},{id:\"minecraft:blaze_powder\",Count:1b,tag:{display:{Name:\"{\\\"text\\\":\\\"§4§lBlazing Soul\\\"}\"},Enchantments:[{lvl:1s,id:\"minecraft:unbreaking\"}],AttributeModifiers:[{UUIDMost:6643163485254798509L,UUIDLeast:-9135644038788542450L,Amount:-0.08d,Slot:\"mainhand\",AttributeName:\"generic.movementSpeed\",Operation:1,Name:\"Modifier\"},{UUIDMost:-2899840319788137997L,UUIDLeast:-6474403868551417057L,Amount:10.0d,Slot:\"mainhand\",AttributeName:\"generic.attackDamage\",Operation:0,Name:\"Modifier\"}]}}]}");
		                           }
		                       }).run();
	}
