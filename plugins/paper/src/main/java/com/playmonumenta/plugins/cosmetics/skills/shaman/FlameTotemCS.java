...
public class FlameTotemCS implements CosmeticSkill {
	...
	public void flameTotemBombEnhanced(Player player, Location standEyeLocation, Location targetLocation, Location standLocation, Plugin plugin, double mBombRadius) {
	...
	public void flameTotemBomb(Player player, Location standEyeLocation, Location targetLocation, Location standLocation, Plugin plugin, double mBombRadius) {
