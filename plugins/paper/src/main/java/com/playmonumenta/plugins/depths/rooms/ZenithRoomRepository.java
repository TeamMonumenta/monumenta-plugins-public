...
public class ZenithRoomRepository extends RoomRepository {
	...
	protected void initRooms() {
		...
		mF1NormalRooms.add(new DepthsRoom("depths2/f1r29", DepthsRoomType.ABILITY, new Vector(51, 43, 47), new Vector(1.0, -0.0, -13.0), 15, DepthsRoom.RoomDirection.UP));
		...
		//F1 elite rooms
		mF1EliteRooms.add(new DepthsRoom("depths2/f1r1", DepthsRoomType.ABILITY, new Vector(53, 35, 43), new Vector(1.0, -7.0, -10.0), 25, DepthsRoom.RoomDirection.EVEN));
		...
		mF1EliteRooms.add(new DepthsRoom("depths2/f1r14", DepthsRoomType.ABILITY, new Vector(122, 45, 69), new Vector(1.0, -7.0, -38.0), 28, DepthsRoom.RoomDirection.EVEN));
		...
		mF2EliteRooms.add(new DepthsRoom("depths2/f2r23", DepthsRoomType.ABILITY, new Vector(107, 65, 80), new Vector(1.0, -48.0, -45.0), 40, DepthsRoom.RoomDirection.DOWN));
		...
		mF3NormalRooms.add(new DepthsRoom("depths2/f3r2", DepthsRoomType.ABILITY, new Vector(54, 42, 45), new Vector(1.0, -2.0, -22.0), 19, DepthsRoom.RoomDirection.UP));
		...
		mF3NormalRooms.add(new DepthsRoom("depths2/f3r9", DepthsRoomType.ABILITY, new Vector(116, 56, 79), new Vector(1.0, -24.0, -13.0), 21, DepthsRoom.RoomDirection.EVEN));
