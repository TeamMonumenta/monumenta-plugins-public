...
public class SvalgotBoneSweep extends Spell {
	...
	public SvalgotBoneSweep(Plugin plugin, LivingEntity boss, Svalgot bossClass) {
		mPlugin = plugin;
		mBoss = boss;
	...
	public void run() {
		...
		new BukkitRunnable() {
			...
			public void run() {
				...
				world.spawnParticle(Particle.LAVA, loc, 1, 0.25, 0.1, 0.25, 0.25);
