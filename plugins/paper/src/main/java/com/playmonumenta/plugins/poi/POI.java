...
public enum POI {
	...
	AMANITA_COLONY("amanita_colony", "Amanita Colony", "epic:r3/world/poi/amanita_colony/endweekly_v2", "#4C8F4D", "wolfswood"),
	ARX_SPIRENSIS("arx_spirensis", "Arx Spirensis", "epic:r3/world/poi/arx_spirensis/endweekly_v2", "#C4BBA5", "keep"),
	BEWITCHED_DOMINION("bewitched_dominion", "Bewitched Dominion", "epic:r3/world/poi/farm/endweekly_v2", "#4C8F4D", "wolfswood"),
	CELESTIAL_RAMPART("celestial_rampart", "Celestial Rampart", "epic:r3/world/poi/celestial_rampart/endweekly_v2", "#342768", "starpoint"),
	CHANTERELLE_VILLAGE("chanterelle_village", "Chanterelle Village", "epic:r3/world/poi/chanterelle_village/endweekly_v2", "#4C8F4D", "wolfswood"),
	CHITTERING_GUTTERS("chittering_gutters", "Chittering Gutters", "epic:r3/world/poi/chittering_gutters/endweekly_v2", "#342768", "starpoint"),
	...
	SHADOWCAST_BASTILLE("shadowcast_bastille", "Shadowcast Bastille", "epic:r3/world/poi/silverstrike_bastille/endweekly_v2", "#4C8F4D", "wolfswood"),
