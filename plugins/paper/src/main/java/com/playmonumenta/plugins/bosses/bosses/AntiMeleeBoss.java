...
public final class AntiMeleeBoss extends BossAbilityGroup {
	public static final String identityTag = "boss_antimelee";

	@BossParam(help = "The launcher gains damage immunity to close range attacks")
	public static class Parameters extends BossParameters {
		...
		@BossParam(help = "Attacks originating from a damager within this radius are mitigated")
		public int DISTANCE = 12;
	}

	private final int mDistanceSquared;

	public AntiMeleeBoss(final Plugin plugin, final LivingEntity boss) {
		super(plugin, identityTag, boss);
		final Parameters p = BossParameters.getParameters(mBoss, identityTag, new AntiMeleeBoss.Parameters());
