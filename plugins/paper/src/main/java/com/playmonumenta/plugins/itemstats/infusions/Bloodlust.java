...
public class Bloodlust implements Infusion {
    private final static int DISTANCE_SQUARED = 8 * 8; // 8 blocks
    private final static String BLOODLUST_EFFECT = "BloodlustDamage";
    private final static int MAX_STACKS = 10;
    private final static double DAMAGE_BONUS = 0.005;
    private final static int DURATION = Constants.TICKS_PER_SECOND * 5;
