...
public class Expedite implements Infusion {
	...
	public static final double PERCENT_SPEED_PER_LEVEL = 0.01;
	...
	public void onDamage(Plugin plugin, Player player, double value, DamageEvent event, LivingEntity enemy) {
		...
		if (MetadataUtils.checkOnceThisTick(plugin, player, CHECK_ONCE_THIS_TICK_METAKEY)) {
			...
			player.getWorld().playSound(player.getLocation(), Sound.ENTITY_PLAYER_LEVELUP, SoundCategory.PLAYERS, 0.1f, 1.0f);
		}
	}
