...
public class Icebreaker extends DepthsAbility {
	...
	private double getDebuffMultiplier(LivingEntity entity) {
		if (!PotionUtils.getNegativeEffects(mPlugin, entity).isEmpty() || EntityUtils.isStunned(entity) || EntityUtils.isStaggered(entity) || EntityUtils.isParalyzed(mPlugin, entity) || EntityUtils.isBleeding(mPlugin, entity)
