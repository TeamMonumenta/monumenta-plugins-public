...
public class SludgeScatterShot extends Spell {
	...
	private static final double ANGLE_VARIATION = 0.15;
	...
	private void createShot(Location targetLocation) {
		BukkitRunnable runnable = new BukkitRunnable() {
			int mTicks = 0;
			...
			public void run() {
				...
				if (mTicks == TELEGRAPH_TIME) {
					...
					if (FastUtils.randomIntInRange(1, IMPACT_LOCATIONS) == 1) {
