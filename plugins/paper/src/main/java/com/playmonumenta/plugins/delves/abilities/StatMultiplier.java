...
public class StatMultiplier {
	...
	static {
		...
		STAT_COMPENSATION_MAPPINGS_RING_POI.put("Amanita Colony", FOREST);
		...
		STAT_COMPENSATION_MAPPINGS_RING_POI.put("Celestial Rampart", STAR_POINT);
		STAT_COMPENSATION_MAPPINGS_RING_POI.put("Constellation Tower", STAR_POINT);
		STAT_COMPENSATION_MAPPINGS_RING_POI.put("Starbound Sanctuary", STAR_POINT);
