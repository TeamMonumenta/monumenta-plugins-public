...
public class Unyielding extends StatMultiplier {
	...
	private static final double UNYIELDING_DAMAGE_DEALT_MULTIPLIER = 0.625;
	...
	public Unyielding(Plugin plugin, World world, Player player) {
		super(plugin, world, player,
				...
				UNYIELDING_DAMAGE_DEALT_MULTIPLIER, UNYIELDING_DAMAGE_TAKEN_MULTIPLIER, UNYIELDING_DAMAGE_TAKEN_MULTIPLIER, UNYIELDING_SPEED_MULTIPLIER);
	}
