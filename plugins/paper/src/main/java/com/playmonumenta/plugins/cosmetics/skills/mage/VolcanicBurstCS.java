			...
			public void run() {
				...
				for (double degree = 30; degree <= 150; degree += 30) {
					...
					for (int i = 0; i < mHeight; i++) {
						...
						new PartialParticle(flame, hLoc, 5, 0.15, 0.15, 0.15, 0.1).spawnAsPlayerActive(mPlayer);
					}
					new PartialParticle(Particle.LAVA, l, 3, 0.2, 0.05, 0.2, 0.075).spawnAsPlayerActive(mPlayer);
					new PartialParticle(Particle.SMOKE_NORMAL, l, 25, 0.1, 0.05, 0.1, 0.1).spawnAsPlayerActive(mPlayer);
