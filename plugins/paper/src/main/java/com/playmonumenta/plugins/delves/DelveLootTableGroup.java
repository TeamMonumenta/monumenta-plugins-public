...
public class DelveLootTableGroup {
	...
	static {
		...
		new DelveLootTableGroup("r3/world/poi/amanita_colony/delves/base_final", "r3/world/poi/amanita_colony/delves/dmat_final", "r3/world/poi/amanita_colony/delves/cmat_final", "r3/world/poi/amanita_colony/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// arx
		...
		new DelveLootTableGroup("r3/world/poi/arx_spirensis/delves/base_final", "r3/world/poi/arx_spirensis/delves/dmat_final", "r3/world/poi/arx_spirensis/delves/cmat_final", "r3/world/poi/arx_spirensis/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// cathedral
		...
		new DelveLootTableGroup("r3/world/poi/cathedral/delves/base_final", "r3/world/poi/cathedral/delves/dmat_final", "r3/world/poi/cathedral/delves/cmat_final", "r3/world/poi/cathedral/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// chanterelle
		...
		new DelveLootTableGroup("r3/world/poi/chanterelle_village/delves/base_final", "r3/world/poi/chanterelle_village/delves/dmat_final", "r3/world/poi/chanterelle_village/delves/cmat_final", "r3/world/poi/chanterelle_village/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// coven
		...
		new DelveLootTableGroup("r3/world/poi/coven_fortress/delves/base_final", "r3/world/poi/coven_fortress/delves/dmat_final", "r3/world/poi/coven_fortress/delves/cmat_final", "r3/world/poi/coven_fortress/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// doomed
		...
		new DelveLootTableGroup("r3/world/poi/farm/delves/base_final", "r3/world/poi/farm/delves/dmat_final", "r3/world/poi/farm/delves/cmat_final", "r3/world/poi/farm/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// forsaken
		...
		new DelveLootTableGroup("r3/world/poi/forsaken_manor/delves/base_final", "r3/world/poi/forsaken_manor/delves/dmat_final", "r3/world/poi/forsaken_manor/delves/cmat_final", "r3/world/poi/forsaken_manor/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// locum
		...
		new DelveLootTableGroup("r3/world/poi/locum_vernatia/delves/base_final", "r3/world/poi/locum_vernatia/delves/dmat_final", "r3/world/poi/locum_vernatia/delves/cmat_final", "r3/world/poi/locum_vernatia/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// silverstrike
		...
		new DelveLootTableGroup("r3/world/poi/silverstrike_bastille/delves/base_final", "r3/world/poi/silverstrike_bastille/delves/dmat_final", "r3/world/poi/silverstrike_bastille/delves/cmat_final", "r3/world/poi/silverstrike_bastille/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// terracotta
		...
		new DelveLootTableGroup("r3/world/poi/terracotta_mine/delves/base_final", "r3/world/poi/terracotta_mine/delves/dmat_final", "r3/world/poi/terracotta_mine/delves/cmat_final", "r3/world/poi/terracotta_mine/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// vibrant
		...
		new DelveLootTableGroup("r3/world/poi/vibrant_hollow/delves/base_final", "r3/world/poi/vibrant_hollow/delves/dmat_final", "r3/world/poi/vibrant_hollow/delves/cmat_final", "r3/world/poi/vibrant_hollow/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// waterfall
		...
		new DelveLootTableGroup("r3/world/poi/waterfall_village/delves/base_final", "r3/world/poi/waterfall_village/delves/dmat_final", "r3/world/poi/waterfall_village/delves/cmat_final", "r3/world/poi/waterfall_village/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
	}
