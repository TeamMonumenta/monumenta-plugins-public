...
public class DelveLootTableGroup {
	...
	static {
		...
		new DelveLootTableGroup("r3/world/poi/doomed_encampment/delves/base_final", "r3/world/poi/doomed_encampment/delves/dmat_final", "r3/world/poi/doomed_encampment/delves/cmat_final", "r3/world/poi/doomed_encampment/endchest", "r3/world/poi/coven_fortress/endchest2").mapDelveLootTables(DELVE_LOOT_TABLE_REPLACEMENT_MAPPINGS);
		// farm
