...
public enum CharmEffects {
	...
	PYROMANIA_DAMAGE_PER_MOB("Pyromania Damage Per Mob", Pyromania.INFO, true, true, 1.0, 5.0, new double[] {0.8, 1.6, 2.4, 3.2, 4.0}),
	...
	PROJECTILE_MASTERY_DAMAGE_MULTIPLIER("Projectile Mastery Damage Multiplier", ProjectileMastery.INFO, true, true, 2.0, 10.0, new double[] {2.25, 4.5, 6.75, 9.0, 11.25}),
