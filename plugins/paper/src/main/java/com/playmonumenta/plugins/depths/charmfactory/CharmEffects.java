...
public enum CharmEffects {
	...
	BOTTLED_SUNLIGHT_BOTTLE_VELOCITY("Bottled Sunlight Bottle Velocity", BottledSunlight.INFO, true, true, 0.0, 100.0, new double[] {0.0, 0.0, 25.0, 50.0, 0.0}),
	...
	WARD_OF_LIGHT_CONE_ANGLE("Ward of Light Cone Angle", WardOfLight.INFO, true, true, 0, 100.0, new double[] {0.0, 0.0, 25.0, 50.0, 0.0}),
	...
	TAUNT_DAMAGE_BONUS("Taunt Damage Bonus", Taunt.INFO, true, false, 5.0, 80.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	...
	FIREBALL_FIRE_DURATION("Fireball Fire Duration", Fireball.INFO, false, false, 0.0, 10.0, new double[] {1.0, 2.0, 3.0, 0.0, 0.0}),
	...
	FLAME_SPIRIT_FIRE_DURATION("Flame Spirit Fire Duration", FlameSpirit.INFO, false, false, 0.0, 10.0, new double[] {1.0, 2.0, 3.0, 0.0, 0.0}),
	...
	FLAMESTRIKE_CONE_ANGLE("Flamestrike Cone Angle", Flamestrike.INFO, true, true, 0.0, 100.0, new double[] {0.0, 0.0, 20.0, 40.0, 0.0}),
	FLAMESTRIKE_FIRE_DURATION("Flamestrike Fire Duration", Flamestrike.INFO, false, false, 0.0, 10.0, new double[] {1.0, 2.0, 3.0, 0.0, 0.0}),
	FLAMESTRIKE_KNOCKBACK("Flamestrike Knockback", Flamestrike.INFO, true, true, 0.0, 100.0, new double[] {0.0, 0.0, 20.0, 40.0, 0.0}),
	...
	IGNEOUS_RUNE_FIRE_DURATION("Igneous Rune Fire Duration", IgneousRune.INFO, false, false, 0.0, 10.0, new double[] {1.0, 2.0, 3.0, 0.0, 0.0}),
	...
	PYROBLAST_FIRE_DURATION("Pyroblast Fire Duration", Pyroblast.INFO, false, false, 0.0, 10.0, new double[] {1.0, 2.0, 3.0, 0.0, 0.0}),
	...
	VOLCANIC_COMBOS_FIRE_DURATION("Volcanic Combos Fire Duration", VolcanicCombos.INFO, false, false, 0.0, 10.0, new double[] {1.0, 2.0, 3.0, 0.0, 0.0}),
	...
	VOLCANIC_METEOR_FIRE_DURATION("Volcanic Meteor Fire Duration", VolcanicMeteor.INFO, false, false, 0.0, 10.0, new double[] {1.0, 2.0, 3.0, 0.0, 0.0}),
	...
	CRYOBOX_ICE_DURATION("Cryobox Ice Duration", Cryobox.INFO, false, false, 0.0, 0.0, new double[] {2.0, 3.0, 4.0, 0.0, 0.0}),
	...
	FROST_NOVA_ICE_DURATION("Frost Nova Ice Duration", DepthsFrostNova.INFO, false, false, 0.0, 0.0, new double[] {2.0, 3.0, 4.0, 0.0, 0.0}),
	...
	ICE_BARRIER_CAST_RANGE("Ice Barrier Cast Range", IceBarrier.INFO, false, true, 20.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 0.0}),
	ICE_BARRIER_MAX_LENGTH("Ice Barrier Max Length", IceBarrier.INFO, false, true, 20.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 0.0}),
	ICE_BARRIER_DAMAGE("Ice Barrier Damage", IceBarrier.INFO, false, true, 5.0, 80.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	ICE_BARRIER_ICE_DURATION("Ice Barrier Ice Duration", IceBarrier.INFO, false, false, 0.0, 0.0, new double[] {2.0, 3.0, 4.0, 0.0, 0.0}),
	...
	ICE_LANCE_ICE_DURATION("Ice Lance Ice Duration", Permafrost.INFO, false, false, 0.0, 0.0, new double[] {2.0, 3.0, 4.0, 0.0, 0.0}),
	...
	PIERCING_COLD_ICE_DURATION("Piercing Cold Ice Duration", PiercingCold.INFO, false, false, 0.0, 0.0, new double[] {2.0, 3.0, 4.0, 0.0, 0.0}),
	...
	CHAOS_DAGGER_VELOCITY("Chaos Dagger Velocity", ChaosDagger.INFO, true, true, 0.0, 100.0, new double[] {0.0, 0.0, 25.0, 50.0, 0.0}),
	...
	FOCUSED_COMBOS_BLEED_AMPLIFIER("Focused Combos Bleed Amplifier", FocusedCombos.INFO, false, true, 5, 40, new double[] {5, 7.5, 10, 12.5, 0.0}),
	FOCUSED_COMBOS_BLEED_DURATION("Focused Combos Bleed Duration", FocusedCombos.INFO, true, false, 0.25, 4.0, new double[] {0.5, 0.75, 1.0, 0.0, 0.0}),
	...
	SCRAPSHOT_VELOCITY("Scrapshot Recoil Velocity", Scrapshot.INFO, true, true, 0.0, 100.0, new double[] {0.0, 0.0, 25.0, 50.0, 0.0}),
	SCRAPSHOT_SHRAPNEL_CONE_ANGLE("Scrapshot Shrapnel Cone Angle", Scrapshot.INFO, true, true, 0.0, 100.0, new double[] {0.0, 0.0, 20.0, 40.0, 0.0}),
	...
	STEEL_STALLION_HORSE_SPEED("Steel Stallion Horse Speed", SteelStallion.INFO, true, true, 5, 0.0, new double[] {3, 6, 9, 12, 0.0}),
	STEEL_STALLION_JUMP_STRENGTH("Steel Stallion Jump Strength", SteelStallion.INFO, true, false, 0.1, 0.0, new double[] {0.05, 0.1, 0.15, 0.2, 0.0}),
	...
	WIND_WALK_VELOCITY("Wind Walk Velocity", DepthsWindWalk.INFO, true, true, 0.0, 100.0, new double[] {0.0, 0.0, 25.0, 50.0, 0.0}),
