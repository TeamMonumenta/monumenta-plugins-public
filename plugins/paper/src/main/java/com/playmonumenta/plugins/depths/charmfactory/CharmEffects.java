...
public enum CharmEffects {
	...
	ETERNAL_SAVIOR_RADIUS("Eternal Savior Radius", EternalSavior.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	LIGHTNING_BOTTLE_DAMAGE("Lightning Bottle Damage", LightningBottle.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	LIGHTNING_BOTTLE_RADIUS("Lightning Bottle Radius", LightningBottle.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	SOOTHING_COMBOS_RANGE("Soothing Combos Range", SoothingCombos.INFO, false, true, 10, 100, new double[] {20, 30, 40, 50, 60}),
	...
	TOTEM_OF_SALVATION_RADIUS("Totem of Salvation Radius", TotemOfSalvation.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	WARD_OF_LIGHT_HEAL_RADIUS("Ward of Light Heal Radius", WardOfLight.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	WARD_OF_LIGHT_CONE_ANGLE("Ward of Light Cone Angle", WardOfLight.INFO, true, true, 10.0, 100.0, new double[] {0.0, 0.0, 0.0, 20.0, 40.0}),

	// Earthbound
	BRAMBLE_SHELL_DAMAGE("Bramble Shell Damage", BrambleShell.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	...
	CRUSHING_EARTH_DAMAGE("Crushing Earth Damage", CrushingEarth.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	CRUSHING_EARTH_RANGE("Crushing Earth Range", CrushingEarth.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	EARTHQUAKE_DAMAGE("Earthquake Damage", Earthquake.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	EARTHQUAKE_RADIUS("Earthquake Radius", Earthquake.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	ENTRENCH_RADIUS("Entrench Radius", Entrench.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	TAUNT_RANGE("Taunt Range", Taunt.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	APOCALYPSE_DAMAGE("Apocalypse Damage", Apocalypse.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	APOCALYPSE_RADIUS("Apocalypse Radius", Apocalypse.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	DETONATION_DAMAGE("Detonation Damage", Detonation.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	DETONATION_DAMAGE_RADIUS("Detonation Damage Radius", Detonation.INFO, false, true, 10.0, 200.0, new double[] {0, 0, 0, 25.0, 30.0}),
	DETONATION_DEATH_RADIUS("Detonation Death Radius", Detonation.INFO, false, true, 10.0, 100.0, new double[] {0, 0, 0, 50.0, 60.0}),
	...
	FLAMESTRIKE_DAMAGE("Flamestrike Damage", Flamestrike.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	FLAMESTRIKE_RANGE("Flamestrike Range", Flamestrike.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	PYROBLAST_RADIUS("Pyroblast Radius", Pyroblast.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	VOLCANIC_METEOR_DAMAGE("Volcanic Meteor Damage", VolcanicMeteor.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	VOLCANIC_METEOR_RADIUS("Volcanic Meteor Radius", VolcanicMeteor.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	FRIGID_COMBOS_DAMAGE("Frigid Combos Damage", FrigidCombos.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	FRIGID_COMBOS_RADIUS("Frigid Combos Radius", FrigidCombos.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	ICE_BARRIER_DAMAGE("Ice Barrier Damage", IceBarrier.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	...
	ICE_LANCE_DAMAGE("Ice Lance Damage", IceLance.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	...
	PIERCING_COLD_DAMAGE("Piercing Cold Damage", PiercingCold.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	...
	ADVANCING_SHADOWS_DAMAGE_MULTIPLIER("Advancing Shadows Damage Multiplier", DepthsAdvancingShadows.INFO, false, true, 5.0, 50, new double[] {5.0, 7.5, 10.0, 12.5, 15.0}),
	...
	BLADE_FLURRY_DAMAGE("Blade Flurry Damage", BladeFlurry.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	BLADE_FLURRY_RADIUS("Blade Flurry Radius", BladeFlurry.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	BRUTALIZE_DAMAGE("Brutalize Damage", Brutalize.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	...
	CLOAK_OF_SHADOWS_RADIUS("Cloak of Shadows Radius", CloakOfShadows.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	DARK_COMBOS_VULNERABILITY_AMPLIFIER("Dark Combos Vulnerability Amplifier", DarkCombos.INFO, false, true, 5, 25, new double[] {5, 6.25, 7.5, 8.75, 10}),
	...
	DUMMY_DECOY_AGGRO_RADIUS("Dummy Decoy Aggro Radius", DummyDecoy.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	DUMMY_DECOY_STUN_RADIUS("Dummy Decoy Stun Radius", DummyDecoy.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	ESCAPE_ARTIST_STUN_RADIUS("Escape Artist Stun Radius", EscapeArtist.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	SHADOW_SLAM_DAMAGE("Shadow Slam Damage", ShadowSlam.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	SHADOW_SLAM_RADIUS("Shadow Slam Radius", ShadowSlam.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	FIREWORK_BLAST_DAMAGE("Firework Blast Damage", FireworkBlast.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	...
	FIREWORK_BLAST_RADIUS("Firework Blast Radius", FireworkBlast.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	RAPID_FIRE_DAMAGE("Rapid Fire Damage", RapidFire.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	...
	SPLIT_ARROW_RANGE("Split Arrow Range", DepthsSplitArrow.INFO, false, true, 10, 100, new double[] {20, 30, 40, 50, 60}),
	...
	GUARDING_BOLT_DAMAGE("Guarding Bolt Damage", GuardingBolt.INFO, false, true, 10.0, 100.0, new double[] {10.0, 15.0, 20.0, 25.0, 30.0}),
	GUARDING_BOLT_RADIUS("Guarding Bolt Radius", GuardingBolt.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	HOWLING_WINDS_RADIUS("Howling Winds Radius", HowlingWinds.INFO, false, true, 10.0, 100.0, new double[] {20.0, 30.0, 40.0, 50.0, 60.0}),
	...
	LAST_BREATH_RADIUS("Last Breath Radius", LastBreath.INFO, false, true, 10, 100, new double[] {20, 30, 40, 50, 60}),
