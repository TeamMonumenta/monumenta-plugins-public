...
public enum CharmEffects {
	...
	SUNDROPS_SPEED_AMPLIFIER("Sundrops Speed Amplifier", Sundrops.INFO, false, true, 5, 30, new double[]{5, 7.5, 10, 12.5, 15}),
	SUNDROPS_RESISTANCE_AMPLIFIER("Sundrops Resistance Amplifier", Sundrops.INFO, true, true, 1.0, 10.0, new double[]{0.0, 0.0, 0.0, 2.5, 5.0}),
	...
	ENTRENCH_COOLDOWN(Entrench.CHARM_COOLDOWN, Entrench.INFO, false, true, 3.0, -30.0, new double[]{-5.0, -7.5, -10.0, -12.5, -15.0}),
	ENTRENCH_KNOCKBACK("Entrench Knockback", Entrench.INFO, true, true, 10.0, 100.0, new double[]{20.0, 25.0, 30.0, 35.0, 40.0}),
	...
	FLAME_SPIRIT_COOLDOWN(FlameSpirit.CHARM_COOLDOWN, FlameSpirit.INFO, false, true, 3.0, -30.0, new double[]{-5.0, -7.5, -10.0, -12.5, -15.0}),
	...
	PERMAFROST_SLOWNESS_AMPLIFIER("Permafrost Slowness Amplifier", Permafrost.INFO, false, true, 2.0, 15.0, new double[]{4.0, 5.0, 6.0, 7.0, 8.0}),
	PERMAFROST_VULNERABILITY_AMPLIFIER("Permafrost Vulnerability Amplifier", Permafrost.INFO, false, true, 2.0, 15.0, new double[]{4.0, 5.0, 6.0, 7.0, 8.0}),
	...
	PHANTOM_FORCE_COOLDOWN(PhantomForce.CHARM_COOLDOWN, PhantomForce.INFO, false, true, 3.0, -30.0, new double[]{-5.0, -7.5, -10.0, -12.5, -15.0}),
	...
	PHANTOM_FORCE_VULNERABILITY_AMPLIFIER("Phantom Force Vulnerability Amplifier", PhantomForce.INFO, false, true, 2.0, 15.0, new double[]{4.0, 5.0, 6.0, 7.0, 8.0}),
	PHANTOM_FORCE_VULNERABILITY_DURATION("Phantom Force Vulnerability Duration", PhantomForce.INFO, true, false, 0.5, 5.0, new double[]{0.5, 1.0, 1.5, 2.0, 2.5}),
	PHANTOM_FORCE_RADIUS("Phantom Force Radius", PhantomForce.INFO, false, true, 5.0, 50.0, new double[]{10.0, 15.0, 20.0, 25.0, 30.0}),
	...
	WHIRLWIND_COOLDOWN(Whirlwind.CHARM_COOLDOWN, Whirlwind.INFO, false, true, 3.0, -30.0, new double[]{-5.0, -7.5, -10.0, -12.5, -15.0}),
	WHIRLWIND_COOLDOWN_REDUCTION("Whirlwind Cooldown Reduction", Whirlwind.INFO, false, true, 2, 10, new double[]{0.0, 0.0, 2.0, 3.0, 5.0}),
	...
	public boolean isValidAtLevel(int level) {
		return mRarityValues[level - 1] != 0.0;
	}
	...
	public boolean isNotRestrictedAtLevel(int level, boolean isNegative) {
		...
		return extraRarityCaps.get(mEffectName) == null || level <= extraRarityCaps.get(mEffectName); // disallow it if it's something like Legendary Fire Duration
// if it's not in the map, it's allowed
	}
