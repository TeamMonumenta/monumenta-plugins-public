...
public class SpellSurroundingDeath extends Spell {
	...
	public void run() {
		...
		Bukkit.getScheduler().runTaskLater(mPlugin, () -> cast(16, 21), 40);
		Bukkit.getScheduler().runTaskLater(mPlugin, () -> cast(9, 16), 80);
		Bukkit.getScheduler().runTaskLater(mPlugin, () -> cast(0, 9), 120);
	}
