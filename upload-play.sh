...
scp -P 9922 $bungee $monumenta rock@beta.playmonumenta.com:/home/rock/project_epic/server_config/plugins/
ssh -p 9922 rock@beta.playmonumenta.com "cd /home/rock/project_epic/server_config/plugins && rm -f Monumenta-Bungee-Plugins.jar Monumenta-Plugins.jar ; ln -s $bungee Monumenta-Bungee-Plugins.jar; ln -s $monumenta Monumenta-Plugins.jar"
