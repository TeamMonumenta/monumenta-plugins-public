...
public class ThePlague extends Quest {
	public ThePlague(World world) {
		...
		addMarker(new LocationMarker(this, new Location(world, 426, 255, 249), "Next C'Taz needs precisely 16 spirit flowers from the hallowed pond East of his hut.", 8));
