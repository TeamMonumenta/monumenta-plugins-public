...
public class MagesLegacy extends Quest {
	public MagesLegacy(World world) {
		...
		addMarker(new LocationMarker(this, new Location(world, -735, 255, 119), "Bring the translated books back to Vargos in the academy and he'll tell you his story.", 14));
	}
}
