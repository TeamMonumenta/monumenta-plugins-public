...
public class Pyromania extends Quest {
	public Pyromania(World world) {
		...
		addMarker(new LocationMarker(this, new Location(world, 744, 255, 88), "Carbocius needs magma samples. Retrieve one from the flame chasm, east of Farr, and return when you have samples from 3 locations.", 3));
	}
}
