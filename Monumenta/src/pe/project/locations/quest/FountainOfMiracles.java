...
public class FountainOfMiracles extends Quest {
	public FountainOfMiracles(World world) {
		...
		addMarker(new LocationMarker(this, new Location(world, 490, 255, 389), "Drake spoke of a mysterious fountain in the wilderness. Search the southern jungle for this legend.", 9));
