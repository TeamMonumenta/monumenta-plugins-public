...
public class AzacorNormal extends BossAbilityGroup {
	...
	public AzacorNormal(Plugin plugin, LivingEntity boss, Location spawnLoc, Location endLoc) {
		...
		List<Spell> passiveSpells = Arrays.asList(
			...
			new SpellMinionResist(mBoss, new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 20, 1), detectionRange),
			new SpellMobEffect(mBoss, new PotionEffect(PotionEffectType.FIRE_RESISTANCE, 20, 0))
		);
		...
		events.put(50, (mBoss) -> {
			...
			Utils.executeCommandOnNearbyPlayers(mBoss.getLocation(), detectionRange, "tellraw @s [\"\",{\"text\":\"Foolish mortals! Your efforts mean nothing. You cannot stop me. You will fall, just like the rest.\",\"color\":\"dark_red\"}]");
		});
